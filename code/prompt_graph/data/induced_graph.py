...
def split_induced_graphs(name, data, smallest_size=10, largest_size=30, transfer=False):
    ...
    if not transfer:
        ...
        with open('./data/induced_graph/'+ 'transfer_' + name +'_induced_graph.pkl', 'wb') as f:
            pickle.dump(graphs_dict, f)
